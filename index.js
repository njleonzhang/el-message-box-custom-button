...
exports.default = {
  ...
  computed: {
    ...
    inCustomButtonMode: function inCustomButtonMode() {
  ...
  methods: {
    ...
    handleCustomAction: function handleCustomAction(button) {
      var _this4 = this;

      if (button.needValidate && this.$type === 'prompt' && !this.validate()) {
        return;
      }
      var result = button.action && button.action(button);
      if (this.isPromise(result)) {
        result.then(function () {
          _this4.handleAction('customize');
        });
      } else {
